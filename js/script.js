document.addEventListener("DOMContentLoaded", (e) => {
  ...
  submitReg.addEventListener("click", function () {
    if (
      ...
      console.error("Error, please write!");
    } else {
      if (
        document.querySelector(".passwordReg__input").value ===
        document.querySelector(".repeatPasswordReg__input").value
        ...
        document.querySelector(".passwordReg__input").style.border =
          "1px solid black";
        document.querySelector(".passwordReg__input").style.borderRadius =
          "2px";
...
document
  ...
  .addEventListener("click", function () {
    ...
    let check = localStorage.getItem("current-login");
    let transactionsArr = JSON.parse(localStorage.getItem(check));
    if (sendMoneyInputValue > transactionsArr.balance) {
      document.querySelector(".send__money-input").style.borderColor = "red";
    } else {
      document.querySelector(".send__money-input").style.borderColor = "black";
